...
urlpatterns = [
    ...
    # Application urls
    path('kyc/', include('phantom_apps.kyc.urls')),
    path('common/', include('phantom_apps.common.urls')),
    ...
    path('fnb/', include('phantom_apps.mock_systems.fnb.urls')),
    path('mobile_money/', include('phantom_apps.mock_systems.mobile_money.urls')),
    
    # Monitoring
    path('monitoring/', include('phantom_apps.monitoring.urls')),
