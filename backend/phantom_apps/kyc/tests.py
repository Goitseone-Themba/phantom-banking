...
class VeriffServiceTests(TestCase):
    ...
    @patch('phantom_apps.kyc.services.veriff_service.VeriffService._verify_webhook_signature')
    def test_handle_webhook_approved(self, mock_verify):
        mock_verify.return_value = True  # Mock successful signature verification
    ...
    @patch('phantom_apps.kyc.services.veriff_service.VeriffService._verify_webhook_signature')
    def test_handle_webhook_rejected(self, mock_verify):
        mock_verify.return_value = True  # Mock successful signature verification
